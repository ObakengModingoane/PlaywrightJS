...
export class PaymentDetailsPage {
    ...
    async enterPersonalInformationDetails(creditCardNumber: any, expiryDateDay: any, expiryDateMonth: any, cvvCode: any, nameOnCard: string) {
    ...
    async enterShippingInformationAndPlaceOrder(selectCountryText: any) {
